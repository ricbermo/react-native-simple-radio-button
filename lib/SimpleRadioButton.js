...
export class RadioButton extends React.Component {
  ...
  render () {
    ...
    const extra = Platform.OS === "ios" ? ". Double tap to select" : "";
    ...
    renderContent = c ? (
      ...
      <View style={[
        ...
        <RadioButtonInput {...this.props}
          accessibilityLabel={accessibilityLabel + ' ' + accessibilityLabelIndex + extra}
          testID={testID + 'Input' + testIDIndex} />
        <RadioButtonLabel {...this.props}
          accessibilityLabel={accessibilityLabel + ' ' + accessibilityLabelIndex}
