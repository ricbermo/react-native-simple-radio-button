    ...
    return (
      <RadioButton
        ...
        accessibilityLabel={(this.props.accessibilityLabel)
          ? (this.props.accessibilityLabel + '|' + this.props.radio_props[i].label) : ('radioButton' + '|' + i)}
...
export class RadioButton extends React.Component {
  ...
  render () {
    ...
    renderContent = c ? (
      ...
      <View
        accessible
        accessibilityLabel={`${accessibilityLabel}. double tap to activate`}
        style={[
          Style.radioWrap,
          this.props.style,
          !this.props.labelHorizontal && Style.labelVerticalWrap
      ...
      >
        <RadioButtonInput {...this.props} testID={testID + 'Input' + testIDIndex} />
        <RadioButtonLabel {...this.props} testID={testID + 'Label' + testIDIndex} />
      </View>
    )
    return (
